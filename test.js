...
const testCron = () => {
    ...
    // 默认
    console.log('默认', false, cron(0, 0, 0, 0, 0, false));
    console.log('默认', true, cron(0, 0, 0, 0, 0, true));

    // 每1分钟
    console.log('每分钟', false, cron(1, 0, 0, 0, 0, false));
    console.log('每分钟', true, cron(1, 0, 0, 0, 0, true));

    // 每2分钟
    console.log('每2分钟', false, cron(2, 0, 0, 0, 0, false));
    console.log('每2分钟', true, cron(2, 0, 0, 0, 0, true));

    // 每小时
    console.log('每小时', false, cron(0, 1, 0, 0, 0, false));
    console.log('每小时', true, cron(0, 1, 0, 0, 0, true));

    // 每2小时
    console.log('每2小时', false, cron(0, 2, 0, 0, 0, false));
    console.log('每2小时', true, cron(0, 2, 0, 0, 0, true));

    // 每天
    console.log('每天', false, cron(0, 0, 1, 0, 0, false));
    console.log('每天', true, cron(0, 0, 1, 0, 0, true));

    // 每2天
    console.log('每2天', false, cron(0, 0, 2, 0, 0, false));
    console.log('每2天', true, cron(0, 0, 2, 0, 0, true));

    // 每个月
    console.log('每个月', false, cron(0, 0, 0, 1, 0, false));
    console.log('每个月', true, cron(0, 0, 0, 1, 0, true));

    // 每2个月
    console.log('每2个月', false, cron(0, 0, 0, 2, 0, false));
    console.log('每2个月', true, cron(0, 0, 0, 2, 0, true));

    // 周日
    console.log('周日', false, cron(0, 0, 0, 0, 1, false));
    console.log('周日', true, cron(0, 0, 0, 0, 1, true));

    // 周一
    console.log('周一', false, cron(0, 0, 0, 0, 2, false));
    console.log('周一', true, cron(0, 0, 0, 0, 2, true));
};
